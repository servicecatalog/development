 ...
 * 
 */
@WebService(name = "SoapHandlerService", targetNamespace = "http://oscm.org/xsd")
...
public interface SoapHandlerService {
    ...
    @Action(input = "http://oscm.org/xsd/SoapHandlerService/initMessageListRequest", output = "http://oscm.org/xsd/SoapHandlerService/initMessageListResponse")
    ...
    @Action(input = "http://oscm.org/xsd/SoapHandlerService/getCollectedMessagesRequest", output = "http://oscm.org/xsd/SoapHandlerService/getCollectedMessagesResponse")
