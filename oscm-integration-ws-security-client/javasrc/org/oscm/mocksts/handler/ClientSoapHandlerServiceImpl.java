 ...
 * 
 */
@WebService(endpointInterface = "org.oscm.mocksts.handler.ClientSoapHandlerService", portName = "ClientSoapHandlerServiceImplPort", serviceName = "ClientSoapHandlerService", targetNamespace = "http://oscm.org/xsd")
public class ClientSoapHandlerServiceImpl implements
        SOAPHandler<SOAPMessageContext>, ClientSoapHandlerService {
    ...
    private synchronized void addMessage(final SOAPMessageContext context) {
        ...
        if (msgText.contains("getCollectedMessages")
                || msgText.contains("initMessageList")) {
            return;
        }
