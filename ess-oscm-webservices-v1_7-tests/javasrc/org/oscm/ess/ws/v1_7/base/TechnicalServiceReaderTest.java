...
public class TechnicalServiceReaderTest {
    ...
    public void setup() throws Exception {
        ...
        configSettings.put("APP_BASE_URL",
                "http://estkulle:8880/fujitsu-bss-app");
    ...
    public void replaceProperties() throws Exception {
        ...
        // then
        assertEquals(
                "provisioningUrl=\"http://estkulle:8880/fujitsu-bss-app\" provisioningVersion=\"1.0\">",
                result);
    }
    ...
    public void replaceProperties_twoReplacements() throws Exception {
        ...
        // then
        assertEquals(
                "provisioningUrl=\"http://estkulle:8880/fujitsu-bss-app\" provisioningVersion=\"1000\">",
                result);
    }
