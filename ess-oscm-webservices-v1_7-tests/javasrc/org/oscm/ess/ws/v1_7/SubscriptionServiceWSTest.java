...
import com.fujitsu.bss.types.enumtypes.Salutation;
import com.fujitsu.bss.types.enumtypes.SubscriptionStatus;
import com.fujitsu.bss.types.enumtypes.TriggerType;
import com.fujitsu.bss.types.enumtypes.UdaConfigurationType;
import com.fujitsu.bss.types.enumtypes.UserRoleType;
import com.fujitsu.bss.types.exceptions.ConcurrentModificationException;
import com.fujitsu.bss.types.exceptions.DomainObjectException.ClassEnum;
import com.fujitsu.bss.types.exceptions.MandatoryUdaMissingException;
import com.fujitsu.bss.types.exceptions.NonUniqueBusinessKeyException;
import com.fujitsu.bss.types.exceptions.ObjectNotFoundException;
import com.fujitsu.bss.types.exceptions.OperationNotPermittedException;
import com.fujitsu.bss.types.exceptions.OperationPendingException;
import com.fujitsu.bss.types.exceptions.PaymentInformationException;
import com.fujitsu.bss.types.exceptions.PriceModelException;
import com.fujitsu.bss.types.exceptions.ServiceChangedException;
import com.fujitsu.bss.types.exceptions.ServiceParameterException;
import com.fujitsu.bss.types.exceptions.SubscriptionAlreadyExistsException;
import com.fujitsu.bss.types.exceptions.SubscriptionStateException;
import com.fujitsu.bss.types.exceptions.TechnicalServiceNotAliveException;
import com.fujitsu.bss.types.exceptions.TechnicalServiceOperationException;
import com.fujitsu.bss.types.exceptions.ValidationException;
import com.fujitsu.bss.types.exceptions.beans.ApplicationExceptionBean;
import com.fujitsu.bss.vo.VOBillingContact;
import com.fujitsu.bss.vo.VOInstanceInfo;
...
import org.oscm.ess.ws.v1_7.base.PaymentTypeFactory;
import org.oscm.ess.ws.v1_7.base.ServiceFactory;
import org.oscm.ess.ws.v1_7.base.VOFactory;
...
public class SubscriptionServiceWSTest {
    ...
    public static void setUpOnce() throws Exception {
        ...
        subscrServiceForOrgAdmin = ServiceFactory.getDefault()
                .getSubscriptionService(String.valueOf(orgAdmin.getKey()),
                        WebserviceTestBase.DEFAULT_PASSWORD);
    }
    ...
    public void modifySubscriptionBug11736() throws Exception {
        ...
        assertEquals(createdSubscription.getOwnerId(),
                subscriptionManager.getUserId());

        // when
        createdSubscription.setOwnerId(customerUser.getUserId());
        VOSubscriptionDetails modified = subscrServiceForSubManager
    ...
    public void modifySubscriptionBug11736Admin() throws Exception {
        ...
        // when
        createdSubscription.setOwnerId(customerUser.getUserId());
        VOSubscriptionDetails modified = subscrServiceForOrgAdmin
                .modifySubscription(createdSubscription, null, null);
        // then
        String ownerId = modified.getOwnerId();
