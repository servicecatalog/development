...
import org.oscm.ess.ws.v1_7.base.MailReader;
...
public class ConcurrencyTest {
    ...
    private class CreateUserThread extends Thread {
        ...
        public void run() {
            try {
                ...
                for (int i = 0; i < executionTimes; i++) {
                    ...
                    idSrv.createUser(user, Arrays.asList(
                            UserRoleType.ORGANIZATION_ADMIN,
                            UserRoleType.TECHNOLOGY_MANAGER), null);

                    initialPasswordChange(localUserKeys);
        ...
        private void initialPasswordChange(List<String> userKeys)
                throws Exception {
            String userKey = mailReader.readUserKeyFromMail();
            userKeys.add(userKey);
            String userPwd = mailReader.readPasswordFromMail();
