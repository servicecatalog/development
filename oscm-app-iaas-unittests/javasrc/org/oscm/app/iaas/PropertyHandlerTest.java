...
public class PropertyHandlerTest {
    ...
    public void testGetInstanceName() throws Exception {
        ...
        parameters.put(PropertyHandler.INSTANCENAME_CUSTOM, "tstdemo");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetState() throws Exception {
        parameters.put(PropertyHandler.API_STATUS, "VSERVER_CREATING");
        propertyHandler = new PropertyHandler(settings);
        FlowState status = propertyHandler.getState();
    ...
    public void testGetOperation() throws Exception {
        parameters.put(PropertyHandler.OPERATION, "VSERVER_MODIFICATION");
        propertyHandler = new PropertyHandler(settings);
        Operation operation = propertyHandler.getOperation();
    ...
    public void testGetURL() throws Exception {
        configSettings.put(PropertyHandler.IAAS_API_URI, "https://...");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVDiskSize() throws Exception {
        parameters.put(PropertyHandler.VDISK_SIZE, "10");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVDiskName() throws Exception {
        parameters.put(PropertyHandler.VDISK_NAME, "vdisk");
        parameters.put(PropertyHandler.INSTANCENAME_PREFIX, "ess");
        parameters.put(PropertyHandler.INSTANCENAME_CUSTOM, "tstdemo");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVDiskId() throws Exception {
        parameters.put(PropertyHandler.VDISK_ID, "vdiskid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVsysId() throws Exception {
        parameters.put(PropertyHandler.VSYS_ID, "vsyid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVserverId() throws Exception {
        parameters.put(PropertyHandler.VSERVER_ID, "vserverid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetDiskImageId() throws Exception {
        parameters.put(PropertyHandler.DISKIMG_ID, "diskimgid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVserverType() throws Exception {
        parameters.put(PropertyHandler.VSERVER_TYPE, "type");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetNetworkId() throws Exception {
        parameters.put(PropertyHandler.NETWORK_ID, "networkid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetUser() throws Exception {
        configSettings.put(PropertyHandler.IAAS_API_USER, "user");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetPassword() throws Exception {
        configSettings.put(PropertyHandler.IAAS_API_PWD, "pwd");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetTenantId() throws Exception {
        configSettings.put(PropertyHandler.IAAS_API_TENANT, "tenantid");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetVServerList() throws Exception {
        ...
        parameters.put(prefixVServer1, "true");
        parameters.put(prefixVServer1 + "_"
                + PropertyHandler.INSTANCENAME_CUSTOM, "tstdemo1");
        parameters.put(prefixVServer1 + "_" + PropertyHandler.VDISK_NAME,
                "vdisk1");

        parameters.put(prefixVServer2, "true");
    ...
    public void testGetVServerListWithConfig() throws Exception {
        ...
        parameters.put(prefixVServer1 + "_"
                + PropertyHandler.INSTANCENAME_CUSTOM, "tstdemo1");
        parameters.put(prefixVServer1 + "_CONFIG", PropertyHandler.VDISK_NAME
                + "=vdisk1");

        parameters.put(prefixVServer2, "true");
        parameters.put(prefixVServer2 + "_CONFIG", PropertyHandler.VDISK_NAME
                + "=vdisk2;" + PropertyHandler.INSTANCENAME_CUSTOM
                + "=tstdemo2");
    ...
    public void testSetVserverListFirstDisabled() throws Exception {
        ...
        parameters.put(PropertyHandler.VDISK_NAME, "vdisk");
        parameters.put(prefixVServer1, "false");
        parameters.put(prefixVServer1 + "_" + PropertyHandler.VDISK_NAME,
                "vdisk1");
        parameters.put(prefixVServer2, "true");
        parameters.put(prefixVServer2 + "_" + PropertyHandler.VDISK_NAME,
    ...
    public void testSetInvalidNULLValue() throws Exception {
        parameters.put(PropertyHandler.VDISK_NAME, "abc");
        propertyHandler = new PropertyHandler(settings);
    ...
    public void testGetControllerWaitTime_invalid() throws Exception {
        configSettings.put(PropertyHandler.CONTROLLER_WAIT_TIME, "abs");
        propertyHandler = new PropertyHandler(settings);
        long waitTime = propertyHandler.getControllerWaitTime();
    ...
    public void isParallelProvisioning_True() throws ConfigurationException {
        // given
        configSettings
                .put(PropertyHandler.ENABLE_PARALLEL_PROVISIONING, "true");
        propertyHandler = new PropertyHandler(settings);
    ...
    @Test
    public void isParallelProvisioning_WrongValue() throws ConfigurationException {
        // given
        configSettings.put(PropertyHandler.ENABLE_PARALLEL_PROVISIONING,
                "wrong");
        propertyHandler = new PropertyHandler(settings);
