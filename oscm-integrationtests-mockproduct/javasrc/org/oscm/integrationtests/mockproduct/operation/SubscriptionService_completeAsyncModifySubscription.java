...
public class SubscriptionService_completeAsyncModifySubscription implements
        IOperationDescriptor<SubscriptionService> {

    @Override
    public String getName() {
        return "SubscriptionService.completeAsyncModifySubscription";
    }
    ...
    public void call(SubscriptionService service, RequestLogEntry logEntry,
        ...
        service.completeAsyncModifySubscription(subscriptionId, organizationId,
                instance);
    }
