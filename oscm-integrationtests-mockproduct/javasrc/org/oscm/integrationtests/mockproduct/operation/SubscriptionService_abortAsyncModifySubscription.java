...
public class SubscriptionService_abortAsyncModifySubscription implements
        IOperationDescriptor<SubscriptionService> {

    @Override
    public String getName() {
        return "SubscriptionService.abortAsyncModifySubscription";
    }
    ...
    public void call(SubscriptionService service, RequestLogEntry logEntry,
        ...
        service.abortAsyncModifySubscription(subscriptionId, organizationId,
                list);
    }
