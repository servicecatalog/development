...
public class OrganizationalUnitService_revokeVisibleServices implements
    ...
    public String getName() {
        return "OrganizationalUnitService.revokeVisibleServices";
    }
    ...
    public String getComment() {
        return "Sets the listed services as not visible for this organizational unit.";
    }
    ...
    public void call(OrganizationalUnitService service,
        ...
        service.revokeVisibleServices(unitId, Arrays.asList(ids));
