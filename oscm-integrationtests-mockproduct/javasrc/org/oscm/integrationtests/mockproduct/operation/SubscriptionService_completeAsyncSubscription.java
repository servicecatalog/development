...
public class SubscriptionService_completeAsyncSubscription implements
        IOperationDescriptor<SubscriptionService> {

    @Override
    public String getName() {
        return "SubscriptionService.completeAsyncSubscription";
    }
    ...
    public void call(SubscriptionService service, RequestLogEntry logEntry,
        ...
        service.completeAsyncSubscription(subscriptionId, organizationId,
                instance);
    }
