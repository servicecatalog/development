...
public class OrganizationalUnitService_getAccessibleServices implements
    ...
    public String getName() {
        return "OrganizationalUnitService.getAccessibleServices";
    }
    ...
    public String getComment() {
        return "Returns services accessible for all users assigned to this organizational unit.";
    }
    ...
    public void call(OrganizationalUnitService service,
        ...
        List<VOService> accessibleServices = service.getAccessibleServices(unitId, pagination, marketplaceId);
