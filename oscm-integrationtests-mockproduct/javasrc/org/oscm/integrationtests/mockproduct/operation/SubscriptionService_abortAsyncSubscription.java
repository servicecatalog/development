...
public class SubscriptionService_abortAsyncSubscription implements
        IOperationDescriptor<SubscriptionService> {

    @Override
    public String getName() {
        return "SubscriptionService.abortAsyncSubscription";
    }
    ...
    public void call(SubscriptionService service, RequestLogEntry logEntry,
        ...
        service.abortAsyncSubscription(subscriptionId, organizationId, list);
    }
