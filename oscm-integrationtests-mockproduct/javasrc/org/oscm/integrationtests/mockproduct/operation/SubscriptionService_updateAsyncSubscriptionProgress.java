...
public class SubscriptionService_updateAsyncSubscriptionProgress implements
        IOperationDescriptor<SubscriptionService> {

    @Override
    public String getName() {
        return "SubscriptionService.updateAsyncSubscriptionProgress";
    }
    ...
    public void call(SubscriptionService service, RequestLogEntry logEntry,
        ...
        service.updateAsyncSubscriptionProgress(subscriptionId, organizationId,
                list);
    }
