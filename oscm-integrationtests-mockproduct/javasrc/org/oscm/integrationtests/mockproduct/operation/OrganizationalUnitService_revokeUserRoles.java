...
public class OrganizationalUnitService_revokeUserRoles implements
    ...
    public String getName() {
        return "OrganizationalUnitService.revokeUserRoles";
    }
    ...
    public String getComment() {
        return "Revokes user given role type. If user does not have a role with given role type, nothing will happen. Provide either userKey or userId. If no userKey is given or with value '0' then userId will be used to get user.";
    }
    ...
    public void call(OrganizationalUnitService service,
        ...
        long orgUnitKey = Long.parseLong(orgUnitStr.isEmpty() ? "0"
                : orgUnitStr);

        service.revokeUserRoles(createUser(userKey, userId),
