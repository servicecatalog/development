...
import org.oscm.app.vmware.business.statemachine.Actions;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class VMClientFactory extends BaseKeyedPooledObjectFactory<String, VMwareClient> {

    private static final Logger logger = LoggerFactory.getLogger(VMClientFactory.class);
		...
		@Override
		public void destroyObject(String vcenter, PooledObject<VMwareClient> p) throws Exception {
			logger.debug("vcenter: " + vcenter);
			p.getObject().close();			
		}
