...
public enum ConfigurationKey {
    ...
    IDP_PRIVATE_KEY_FILE_PATH(true, "./cakey.der", "string"),
    ...
    IDP_PUBLIC_CERTIFICATE_FILE_PATH(true, "./cacert.der", "string"),
    ...
    @Example("1800000")
    IDP_ASSERTION_EXPIRATION(true, "1800000", "long", Long.valueOf(1L), null, false),
    ...
    @Example("600000")
    IDP_ASSERTION_VALIDITY_TOLERANCE(true, "600000", "long", Long.valueOf(1L), null, false),
    ...
    SEARCH_INDEX_MASTER_FACTORY_NAME(true, "jms/bss/masterIndexerQueueFactory", "string"),

    @Doc({ "The JNDI name of the message queue storing the messages for the search master." })
    @Example("jms/bss/masterIndexerQueue")
    SEARCH_INDEX_MASTER_QUEUE_NAME(true, "jms/bss/masterIndexerQueue", "string"),
