...
public abstract class DomainObjectException extends SaaSApplicationException {
	 ...
	 *            the cause
	 */
	public DomainObjectException(String message, DomainObjectExceptionBean bean, Throwable cause) {
	 ...
	 *            thrown
	 */
	public DomainObjectException(String message, ClassEnum classEnum, String businessKey) {
	...
	public DomainObjectExceptionBean getFaultInfo() {
		return new DomainObjectExceptionBean(super.getFaultInfo(), bean.getClassEnum());
	}
