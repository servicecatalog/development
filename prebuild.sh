...
/opt/apache-ant-1.9.2/bin/ant -file Development/oscm-build/cruisecontrol.xml -Dbuildid.prefix=GL4_with_docker_pull_ESS -lib /opt/jdk1.7.0_45/lib/tools.jar -Xmx4000m -Dhttps.proxyHost=proxy.intern.est.fujitsu.com -Dhttps.proxyPort=8080 -Dhttp.proxyHost=proxy.intern.est.fujitsu.com -Dhttp.proxyPort=8080 prepareForDocker
