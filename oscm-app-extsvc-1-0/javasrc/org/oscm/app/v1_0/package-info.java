 ...
 * platform (APP) of Catalog Manager (CT-MG).
 * <p>
 * APP is a framework for integrating applications with CT-MG
 ...
 * from the CT-MG user interface. Technical service operations 
 ...
 * <p>
 * In order to integrate an application with CT-MG using the APP
