...
public class OperationServiceBean {
    ...
    List<org.oscm.app.v1_0.data.OperationParameter> toController(
            Properties prop) {
        List<org.oscm.app.v1_0.data.OperationParameter> paramList = new ArrayList<org.oscm.app.v1_0.data.OperationParameter>();
        if (prop != null) {
            Set<Object> keys = prop.keySet();
            for (Object key : keys) {
                org.oscm.app.v1_0.data.OperationParameter param = new org.oscm.app.v1_0.data.OperationParameter();
    ...
    List<OperationParameter> toBES(
        ...
        if (operationParameters != null) {
            for (org.oscm.app.v1_0.data.OperationParameter op : operationParameters) {
    ...
    public List<OperationParameter> getParameterValues(String userId,
        ...
        try {
            ...
            List<org.oscm.app.v1_0.data.OperationParameter> operationParameters = controller
