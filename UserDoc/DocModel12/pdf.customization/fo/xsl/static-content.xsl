...
<!-- ######################################################################################### -->
<xsl:template name="insertChapterStaticContents">
    <xsl:call-template name="insertStaticHeader">
        <xsl:with-param name="pagetype" select="string('chapter')"/>
    </xsl:call-template>
    <xsl:call-template name="insertStaticFooter">
        <xsl:with-param name="pagetype" select="string('chapter')"/>
    </xsl:call-template>
</xsl:template>

<!-- ######################################################################################### -->
<xsl:template name="insertStaticContents">
...
<!-- ######################################################################################### -->
<xsl:template name="insertStaticHeader">
    <xsl:param name="pagetype"/>

    <xsl:variable name="varID">
        <xsl:choose>
            <xsl:when test="$pagetype = 'toc' ">
                <xsl:text>Table of Contents</xsl:text>
            </xsl:when>
            <xsl:when test="$pagetype = 'index' ">
                <xsl:text>header.index</xsl:text>
            </xsl:when>
            <xsl:when test="$pagetype = 'preface' ">
                <xsl:text>header.preface</xsl:text>
            </xsl:when>
            <xsl:when test="$pagetype = 'abstract' ">
                <xsl:text>header.abstract</xsl:text>
            </xsl:when>
            <xsl:when test="$pagetype = 'glossary' ">
                <xsl:text>header.glossary</xsl:text>
            </xsl:when>
            <xsl:when test="$pagetype = 'appendix' ">
                <xsl:text>header.appendix</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>header.chapter</xsl:text>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:variable>
<!-- end -->
    ...
    <fo:static-content flow-name="header">
        <fo:block xsl:use-attribute-sets="default.font static.header">
            <xsl:call-template name="insertVariable">
                <xsl:with-param name="theVariableID" select="$varID"/>
...
<!-- ######################################################################################### -->
<xsl:template name="insertStaticFooter">
    <xsl:param name="pagetype"/>

    <fo:static-content flow-name="footer">
        <fo:block xsl:use-attribute-sets="default.font static.footer">

            <fo:list-block xsl:use-attribute-sets="static.footer.list">
                <fo:list-item xsl:use-attribute-sets="static.footer.list.item">
                    <fo:list-item-label xsl:use-attribute-sets="static.footer.list.item.label">
                        <fo:block>
                            <xsl:value-of select="$docTitle"/>
                        </fo:block>
                    </fo:list-item-label>
                    <fo:list-item-body xsl:use-attribute-sets="static.footer.list.item.body">
                        <fo:block>
                            <fo:page-number/>
                            <fo:block/>
                        </fo:block>
