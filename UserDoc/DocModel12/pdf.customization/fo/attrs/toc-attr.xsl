...
<!-- ######################################################################################### -->
<!-- toc headline (block) -->
<xsl:attribute-set name="toc.headline">
    <xsl:attribute name="start-indent">-40pt</xsl:attribute>
</xsl:attribute-set>

<!-- ######################################################################################### -->
<!-- contains a lot of basic-link elements, one for each toc entry (block) -->
<xsl:attribute-set name="toc.block">
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- contains one toc entry  (list-block) -->
    <xsl:attribute-set name="toc.list">
        <!-- sets the space between start of chapter-number and start of chapter-title -->
        <xsl:attribute name="provisional-distance-between-starts">70pt</xsl:attribute>
...
<!-- ######################################################################################### -->
<!-- whole list-item (list-item) -->
<!-- Here, the font sizes for the different levels are defined. Use "toc.chapter.number", "toc.chapter.title", "toc.chapter.leader"
  +  and "toc.chapter.page_number" to set different font-sizes for the different parts.
  + -->
    <xsl:attribute-set name="toc.list.item">
...
<!-- ######################################################################################### -->
<!-- chapter number (list-item-label) -->
<xsl:attribute-set name="toc.list.item.label">
...
<!-- ######################################################################################### -->
<!-- chapter title and page-number (list-item-body) -->
<xsl:attribute-set name="toc.list.item.body">
    <xsl:attribute name="start-indent">body-start()</xsl:attribute>
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- contains a lot of list-blocks, one fore each toc entry (basic-link) -->
<xsl:attribute-set name="toc.basic_link">
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- chapter number (block) -->
<xsl:attribute-set name="toc.chapter.number">
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- chapter title and page-number (block) -->
...
<xsl:attribute-set name="toc.chapter.title">
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- leader between chapter-title and page-number (leader) -->
<xsl:attribute-set name="toc.chapter.leader">
    <xsl:attribute name="leader-pattern">dots</xsl:attribute>
</xsl:attribute-set>


<!-- ######################################################################################### -->
<!-- chapter number (linline) -->
<xsl:attribute-set name="toc.chapter.page_number">
</xsl:attribute-set>
