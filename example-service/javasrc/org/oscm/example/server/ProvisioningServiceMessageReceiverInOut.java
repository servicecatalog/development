...
public class ProvisioningServiceMessageReceiverInOut extends
        ...
        try {
            ...
            if ((op.getName() != null)
                ...
                if ("modifySubscription".equals(methodName)) {
                    ...
                    org.oscm.xsd.ModifySubscriptionResponseE modifySubscriptionResponse1 = null;
                    ...
                    modifySubscriptionResponse1 =

                    skel.modifySubscription(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            modifySubscriptionResponse1, false);
                } else

                if ("deactivateInstance".equals(methodName)) {

                    org.oscm.xsd.DeactivateInstanceResponseE deactivateInstanceResponse3 = null;
                    ...
                    deactivateInstanceResponse3 =

                    skel.deactivateInstance(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            deactivateInstanceResponse3, false);
                } else

                if ("updateUsers".equals(methodName)) {

                    org.oscm.xsd.UpdateUsersResponseE updateUsersResponse5 = null;
                    ...
                    updateUsersResponse5 =

                    skel.updateUsers(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            updateUsersResponse5, false);
                } else

                if ("sendPing".equals(methodName)) {

                    org.oscm.xsd.SendPingResponseE sendPingResponse7 = null;
                    ...
                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            sendPingResponse7, false);
                } else

                if ("asyncModifySubscription".equals(methodName)) {

                    org.oscm.xsd.AsyncModifySubscriptionResponseE asyncModifySubscriptionResponse9 = null;
                    ...
                    asyncModifySubscriptionResponse9 =

                    skel.asyncModifySubscription(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            asyncModifySubscriptionResponse9, false);
                } else

                if ("upgradeSubscription".equals(methodName)) {

                    org.oscm.xsd.UpgradeSubscriptionResponseE upgradeSubscriptionResponse11 = null;
                    ...
                    upgradeSubscriptionResponse11 =

                    skel.upgradeSubscription(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            upgradeSubscriptionResponse11, false);
                } else

                if ("deleteInstance".equals(methodName)) {

                    org.oscm.xsd.DeleteInstanceResponseE deleteInstanceResponse13 = null;
                    ...
                    deleteInstanceResponse13 =

                    skel.deleteInstance(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            deleteInstanceResponse13, false);
                } else

                if ("asyncCreateInstance".equals(methodName)) {

                    org.oscm.xsd.AsyncCreateInstanceResponseE asyncCreateInstanceResponse15 = null;
                    ...
                    asyncCreateInstanceResponse15 =

                    skel.asyncCreateInstance(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            asyncCreateInstanceResponse15, false);
                } else

                if ("activateInstance".equals(methodName)) {

                    org.oscm.xsd.ActivateInstanceResponseE activateInstanceResponse17 = null;
                    ...
                    activateInstanceResponse17 =

                    skel.activateInstance(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            activateInstanceResponse17, false);
                } else

                if ("deleteUsers".equals(methodName)) {

                    org.oscm.xsd.DeleteUsersResponseE deleteUsersResponse19 = null;
                    ...
                    deleteUsersResponse19 =

                    skel.deleteUsers(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            deleteUsersResponse19, false);
                } else

                if ("createInstance".equals(methodName)) {

                    org.oscm.xsd.CreateInstanceResponseE createInstanceResponse21 = null;
                    ...
                    createInstanceResponse21 =

                    skel.createInstance(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            createInstanceResponse21, false);
                } else

                if ("createUsers".equals(methodName)) {

                    org.oscm.xsd.CreateUsersResponseE createUsersResponse23 = null;
                    ...
                    createUsersResponse23 =

                    skel.createUsers(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            createUsersResponse23, false);
                } else

                if ("asyncUpgradeSubscription".equals(methodName)) {

                    org.oscm.xsd.AsyncUpgradeSubscriptionResponseE asyncUpgradeSubscriptionResponse25 = null;
                    ...
                    asyncUpgradeSubscriptionResponse25 =

                    skel.asyncUpgradeSubscription(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            asyncUpgradeSubscriptionResponse25, false);
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.ModifySubscriptionE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(
                    org.oscm.xsd.ModifySubscriptionE.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.DeactivateInstanceE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(
                    org.oscm.xsd.DeactivateInstanceE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.UpdateUsersE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(
                    org.oscm.xsd.UpdateUsersE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.UpdateUsersResponseE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.SendPingE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            return param.getOMElement(
                    org.oscm.xsd.SendPingResponseE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.UpgradeSubscriptionE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            return param.getOMElement(
                    org.oscm.xsd.DeleteInstanceE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.DeleteInstanceResponseE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.AsyncCreateInstanceE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            return param.getOMElement(
                    org.oscm.xsd.ActivateInstanceE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.DeleteUsersE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(
                    org.oscm.xsd.DeleteUsersE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.DeleteUsersResponseE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
        ...
        try {
            return param.getOMElement(
                    org.oscm.xsd.CreateInstanceE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.CreateInstanceResponseE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.CreateUsersE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

        try {
            return param.getOMElement(
                    org.oscm.xsd.CreateUsersE.MY_QNAME,
                    org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
            org.oscm.xsd.CreateUsersResponseE param,
            boolean optimizeContent) throws org.apache.axis2.AxisFault {
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            ...
            if (org.oscm.xsd.ModifySubscriptionResponseE.class
                    .equals(type)) {
            ...
            if (org.oscm.xsd.DeactivateInstanceResponseE.class
                    .equals(type)) {
            ...
            if (org.oscm.xsd.UpdateUsersE.class.equals(type)) {
                ...
                return org.oscm.xsd.UpdateUsersE.Factory.parse(param
            ...
            if (org.oscm.xsd.SendPingE.class.equals(type)) {
                ...
                return org.oscm.xsd.SendPingE.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (org.oscm.xsd.UpgradeSubscriptionResponseE.class
                    .equals(type)) {
            ...
            if (org.oscm.xsd.DeleteInstanceE.class.equals(type)) {
                ...
                return org.oscm.xsd.DeleteInstanceE.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (org.oscm.xsd.AsyncCreateInstanceResponseE.class
                    .equals(type)) {
            ...
            if (org.oscm.xsd.ActivateInstanceResponseE.class
                    .equals(type)) {
            ...
            if (org.oscm.xsd.DeleteUsersE.class.equals(type)) {
                ...
                return org.oscm.xsd.DeleteUsersE.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (org.oscm.xsd.CreateInstanceE.class.equals(type)) {
                ...
                return org.oscm.xsd.CreateInstanceE.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (org.oscm.xsd.CreateUsersE.class.equals(type)) {
                ...
                return org.oscm.xsd.CreateUsersE.Factory.parse(param
                        .getXMLStreamReaderWithoutCaching());
            ...
            if (org.oscm.xsd.AsyncUpgradeSubscriptionE.class
                    .equals(type)) {
