 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CreateUsers.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                       ...
                                       if (localUsers!=null){
                                            for (int i = 0;i < localUsers.length;i++){
                                                if (localUsers[i] != null){
                                                 localUsers[i].serialize(new javax.xml.namespace.QName("","users"),
                                                           factory,xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static CreateUsers parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateUsers object =
                new CreateUsers();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createUsers".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateUsers)org.oscm.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
