...
public class CreateUsers implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * createUsers Namespace URI = http://oscm.org/xsd Namespace Prefix =
     * ns1
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":createUsers", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createUsers", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static CreateUsers parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            CreateUsers object = new CreateUsers();
                        ...
                        if (!"createUsers".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (CreateUsers) org.oscm.xsd.ExtensionMapper
