...
public class InstanceRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addParameterValue(org.oscm.xsd.ServiceParameter param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
                .toList(localParameterValue);
        list.add(param);
        this.localParameterValue = (org.oscm.xsd.ServiceParameter[]) list
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":instanceRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localDefaultLocaleTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "defaultLocale",
                            namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
        ...
        if (localOrganizationIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "organizationId",
                            namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
        ...
        if (localOrganizationNameTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "organizationName",
                            namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
            ...
            if (localParameterValue != null) {
                ...
                if (!namespace2.equals("")) {
                    ...
                    if (prefix2 == null) {
                        ...
                        xmlWriter.writeStartElement(prefix2, "parameterValue",
                                namespace2);
                        xmlWriter.writeNamespace(prefix2, namespace2);
                        xmlWriter.setPrefix(prefix2, namespace2);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static InstanceRequest parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            InstanceRequest object = new InstanceRequest();
