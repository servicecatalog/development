...
public class UpdateUsers implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * updateUsers Namespace URI = http://oscm.org/xsd Namespace Prefix =
     * ns1
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":updateUsers", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "updateUsers", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static UpdateUsers parse(javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            UpdateUsers object = new UpdateUsers();
                        ...
                        if (!"updateUsers".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (UpdateUsers) org.oscm.xsd.ExtensionMapper
