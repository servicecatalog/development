...
public class AsyncUpgradeSubscription
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
            ...
            public void serialize(
                ...
                AsyncUpgradeSubscription.this.serialize(parentQName, factory,
                        xmlWriter);
            }
        };
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":asyncUpgradeSubscription",
                        xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "asyncUpgradeSubscription", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static AsyncUpgradeSubscription parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            AsyncUpgradeSubscription object = new AsyncUpgradeSubscription();
