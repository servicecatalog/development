 ...
 */
                           ...
                           */
                           public  java.lang.String getParameterId(){
                            ...
                            /**
                               ...
                               */
                               public void setParameterId(java.lang.String param){
                            
                                       if (param != null){
                                          //update the setting tracker
                                          localParameterIdTracker = true;
                                       } else {
                                          localParameterIdTracker = false;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ServiceParameter.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":serviceParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "serviceParameter",
                              ...
                              if (localParameterIdTracker){
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"parameterId", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"parameterId");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("parameterId");
                                    }
                                          ...
                                          if (localParameterId==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localParameterId);
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                             ...
                             if (localParameterIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://oscm.org/xsd",
                                        ...
                                        if (localParameterId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParameterId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("parameterId cannot be null!!");
                                        }
                                    } if (localValueTracker){
    ...
    public static class Factory{
        ...
        */
        public static ServiceParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"serviceParameter".equals(type)){
                                ...
                                return (ServiceParameter)org.oscm.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://oscm.org/xsd","parameterId").equals(reader.getName())){
