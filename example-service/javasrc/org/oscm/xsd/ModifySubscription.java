...
public class ModifySubscription implements org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * modifySubscription Namespace URI = http://oscm.org/xsd Namespace
     * Prefix = ns1
     */
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
            ...
            public void serialize(
                ...
                ModifySubscription.this.serialize(parentQName, factory,
                        xmlWriter);
            }
        };
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":modifySubscription", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "modifySubscription", xmlWriter);
            }
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static ModifySubscription parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            ModifySubscription object = new ModifySubscription();
                        ...
                        if (!"modifySubscription".equals(type)) {
                            ...
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (ModifySubscription) org.oscm.xsd.ExtensionMapper
