 ...
 */
        ...
        public  class UserResult extends org.oscm.xsd.BaseResult
                           ...
                           public  org.oscm.xsd.User[] getUsers(){
                             ...
                             */
                             public void addUsers(org.oscm.xsd.User param){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUsers);
                               list.add(param);
                               this.localUsers =
                             (org.oscm.xsd.User[])list.toArray(
                            new org.oscm.xsd.User[list.size()]);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        xmlWriter.writeStartElement("rc");
                                               ...
                                               if (localRc==java.lang.Integer.MIN_VALUE) {
                                                         ...
                                                         throw new org.apache.axis2.databinding.ADBException("rc cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRc));
                                               }
                                       ...
                                       if (localUsers!=null){
                                            for (int i = 0;i < localUsers.length;i++){
                                                if (localUsers[i] != null){
                                                 localUsers[i].serialize(new javax.xml.namespace.QName("http://oscm.org/xsd","users"),
                                                           factory,xmlWriter);
                                                } else {
                                                            ...
                                                            if (! namespace2.equals("")) {
                                                                ...
                                                                if (prefix2 == null) {
                                                                    ...
                                                                    xmlWriter.writeStartElement(prefix2,"users", namespace2);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://oscm.org/xsd","userResult"));
                 if (localDescTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRc));
                             if (localUsersTracker){
                             if (localUsers!=null) {
                                 for (int i = 0;i < localUsers.length;i++){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"userResult".equals(type)){
                                ...
                                return (UserResult)org.oscm.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list3 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://oscm.org/xsd","desc").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://oscm.org/xsd","rc").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://oscm.org/xsd","users").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list3.add(org.oscm.xsd.User.Factory.parse(reader));
                                                                }
                                                        ...
                                                        while(!loopDone3){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://oscm.org/xsd","users").equals(reader.getName())){
                                                        ...
                                                        object.setUsers((org.oscm.xsd.User[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                org.oscm.xsd.User.class,
                                                                list3));
