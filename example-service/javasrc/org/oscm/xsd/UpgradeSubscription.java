...
/**
 * UpgradeSubscription bean class
 */
@SuppressWarnings({ "rawtypes", "unused", "serial", "null", "unchecked" })
public class UpgradeSubscription implements
        org.apache.axis2.databinding.ADBBean {
    /*
     * This type was generated from the piece of schema that had name =
     * upgradeSubscription Namespace URI = http://oscm.org/xsd Namespace
     * Prefix = ns1
     */
    ...
    public void addParameterValues(org.oscm.xsd.ServiceParameter param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil
                .toList(localParameterValues);
        list.add(param);
        this.localParameterValues = (org.oscm.xsd.ServiceParameter[]) list
                .toArray(new org.oscm.xsd.ServiceParameter[list.size()]);
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
            ...
            public void serialize(
                ...
                UpgradeSubscription.this.serialize(parentQName, factory,
                        xmlWriter);
            }
        };
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null)
                ...
                writeAttribute("xsi",
                        ...
                        namespacePrefix + ":upgradeSubscription", xmlWriter);
            } else {
                writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "upgradeSubscription", xmlWriter);
            }
        ...
        if (localSubscriptionIdTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "subscriptionId",
                            namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
    ...
    public static class Factory {
         ...
         * outer element
         */
        public static UpgradeSubscription parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            UpgradeSubscription object = new UpgradeSubscription();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"upgradeSubscription".equals(type)) {
                            // find namespace for the prefix
                            java.lang.String nsUri = reader
                                    .getNamespaceContext().getNamespaceURI(
                                            nsPrefix);
                            return (UpgradeSubscription) org.oscm.xsd.ExtensionMapper
